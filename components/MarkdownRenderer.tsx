...
function renderContent(content: string): string {
  return content
    ...
    .replace(/<ol>/g, '<ol class="list-decimal list-inside space-y-2 mb-6 text-gray-300">')
    .replace(/<li>/g, '<li class="text-gray-300 leading-relaxed pl-2 relative before:absolute before:left-0 before:text-cyber-cyan before:content-[\'▹\']">')
